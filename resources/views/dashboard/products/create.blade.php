            ...
            <form id="productForm" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl p-8">
                    ...
                    <div class="mb-8 pb-4 border-b border-slate-100">
                        ...
                        <p class="text-sm text-slate-500 mt-1">Lengkapi detail di bawah untuk menambahkan item baru.</p>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="w-full h-56 rounded-xl image-upload-area flex flex-col items-center justify-center cursor-pointer relative group overflow-hidden">
                            ...
                            <div id="upload-placeholder" class="text-center p-6 group-hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Kamera CCTV Hikvision Outdoor" required
                        ...
                        <div>
                            ...
                            <input type="text" name="merk" value="{{ old('merk') }}" placeholder="Contoh: Hikvision, Dahua" required
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-brand-500 transition-colors placeholder-slate-400 font-medium text-slate-700">
                            @error('merk')
                                <p class="text-rose-500 text-xs mt-1 font-semibold">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="unit" value="{{ old('unit', 'pcs') }}" placeholder="Contoh: pcs, meter, roll, pack" required
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-brand-500 transition-colors placeholder-slate-400 font-medium text-slate-700">
                            @error('unit')
                                <p class="text-rose-500 text-xs mt-1 font-semibold">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="price" value="{{ old('price') }}" placeholder="0" required min="0" step="any"
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex items-center justify-between p-3 border border-slate-100 rounded-xl hover:bg-slate-50 transition-colors">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <div id="toggle-bg" class="w-11 h-6 {{ old('is_active', '1') == '1' ? 'bg-emerald-500' : 'bg-rose-500' }} peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (quillContainer) {
                ...
                // Load existing description on validation failure
                if (descInput.value) {
